...
export default function Home() {
  ...
  const structuredData = {
    ...
    name: "DFP Travels",
    alternateName: ["DFP TRAVELS", "DFP Travels by DFP CAPITAL SRL"],
    legalName: "DFP CAPITAL SRL",
    url: "https://dfptravels.com/",
    logo: "https://dfptravels.com/logo.png",
    description: "DFP Travels is a luxury travel and chauffeur service by DFP CAPITAL SRL, offering private transfers from Venice, water taxi connections and bespoke tours across Northern Italy.",
  ...
  return (
    <main className="site-shell">
      <Head>
        <title>DFP Travels | Luxury Transfers, Water Taxi & Private Tours in Venice</title>
        <meta name="description" content="Official website of DFP Travels. Luxury private transfers, Venice water taxi connections and bespoke tours from Venice to the Dolomites, Verona, Lake Garda and Northern Italy." />
        <meta name="keywords" content="DFP Travels, DFP TRAVELS, DFP Capital travels, Venice private transfer, Venice airport transfer, Venice water taxi, Dolomites tour from Venice, Venice to Cortina transfer" />
        <meta name="robots" content="index, follow" />
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <meta property="og:site_name" content="DFP Travels" />
        <meta property="og:title" content="DFP Travels | Luxury Transfers & Private Tours in Venice" />
        <meta property="og:description" content="Official website of DFP Travels. Luxury private transfers, Venice water taxi connections and bespoke travel experiences across Northern Italy." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://dfptravels.com/" />
        <meta property="og:image" content="https://dfptravels.com/logo.png" />
        <meta name="twitter:card" content="summary_large_image" />
        <link rel="canonical" href="https://dfptravels.com/" />
        ...
        <div className="container hero-grid hero-grid--simple">
          <div className="hero-copy hero-copy--premium hero-copy--simple">
            ...
            <div className="hero-actions">
              ...
              <a className="btn btn-whatsapp" href="https://wa.me/3904441110003?text=Hello%20DFP%20Travels,%20I%20would%20like%20to%20request%20a%20private%20transfer%20from%20Venice" target="_blank" rel="noopener noreferrer">WhatsApp</a>
            </div>
